...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  var sumString = `${a} and ${b} and ${c} sum to ${sumFinal}.`
  var multiplyString = `The product of ${a} and ${b} and ${c} is ${productFinal}.`;

  return [sumFinal, productFinal, sumString, multiplyString];
}
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  var finalProduct = multiply(firstProduct, multArr[2])[0];
  var arrayProductString = `The numbers ${testArray} have a product of ${finalProduct}.`;

  // console.log([finalProduct, arrayProductString]);
  return [finalProduct, arrayProductString];
}
